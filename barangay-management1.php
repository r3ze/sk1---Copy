                ...
                <div id="generalSection">
                  ...
                  <style>
                    ...
                    #nextButton[disabled]:hover{
                      /* Add styles for disabled button appearance here (e.g., opacity reduction) */
                      /* opacity: 0.5; */
                      cursor:not-allowed;
                    }
                  </style>
                  ...
                  <script>
                    function calculateAge() {
                      ...
                      if (birthdateInput.value === '') {
                        ...
                        document.getElementById('nextButton').style.backgroundColor = '#6c757d';
                        document.getElementById('nextButton').style.borderColor = '#6c757d';
                        document.getElementById('nextButton').style.cursor = 'not-allowed';
                        // Inside your validation logic...
                        // document.getElementById('nextButton').style.pointerEvents = 'none'; // Disable pointer events
