            ...
            (function () {
                ...
                switch (o) {
                  ...
                  case s._const.modifyTextElement:
                    ...
                    s.textDiff(
                      ...
                      u(i.parentNode, "HTMLTextAreaElement") &&
                  ...
                  case s._const.removeTextElement:
                    ...
                    var h = i.parentNode;
                    h.removeChild(i),
                      u(h, "HTMLTextAreaElement") && (h.value = "");
                    break;
                    ...
                    !(function (t, e, s) {
                      switch (e[s._const.action]) {
                        case s._const.addAttribute:
                          ...
                          break;
                        case s._const.modifyAttribute:
                          g(e, s._const.oldValue, s._const.newValue),
                            m(t, e, s);
                          break;
                        case s._const.removeAttribute:
              ...
              function S(t, e) {
                ...
                if (u(t, "Text", "Comment")) s.data = t.data;
                  ...
                  e.valueDiffing &&
                    (u(t, "HTMLTextAreaElement") && (s.value = t.value),
                    ...
                    u(t, "HTMLOptionElement") && (s.selected = t.selected));
                }
                return s;
              }
              var k =
              ...
              var L = {
                ...
                P = function (t, e) {
                  ...
                  for (var o = new RegExp(T), r = null, l = !1; !l; )
                  ...
                  return (
                    t.replace(k, function (r, l) {
                      ...
                      if (d) {
                        if (
                          ("svg" ===
                            (s = P(r, e.caseSensitive || o)).node.nodeName &&
                            (o = !0),
                          n++,
                          !s.voidElement && u && "<" !== u)
                        ) {
                ...
                H = (function () {
                  function t(t, e, s) {
                    (this.options = s),
                      (this.t1 =
                        "undefined" != typeof Element && u(t, "Element")
                          ? S(t, this.options)
                          : "string" == typeof t
                          ? R(t, this.options)
                          : JSON.parse(JSON.stringify(t))),
                      (this.t2 =
                        "undefined" != typeof Element && u(e, "Element")
                          ? S(e, this.options)
                          : "string" == typeof e
                          ? R(e, this.options)
                      ...
                      for (var u = 0; u < a; u += 1) {
                        ...
                        o &&
                            ...
                            ? "#text" === p.nodeName
                              ...
                              : (r.push(
                                  new h()
                                    ...
                                    .setValue(this.options._const.element, x(p))
                                ),
                                (l -= 1))
                            : f &&
                              !p &&
                          ...
                          p &&
                            ...
                            a < this.options.maxChildCount
                              ? (r = r.concat(
                                  this.findNextDiff(p, f, s.concat(l))
                                ))
                              : D(p, f) ||
                                (i.length > n.length
                                  ? ("#text" === p.nodeName
                    ...
                    (t.prototype.attemptGroupRelocation = function (
                      ...
                      for (
                        var a,
                          ...
                          c = (function (t, e, s) {
                            var i = t.childNodes
                                ? O(t.childNodes.length, !0)
                                : [],
                              n = e.childNodes
                                ? O(e.childNodes.length, !0)
                                : [],
                              a = 0;
                            return (
                          ...
                          u = c.gaps1,
                          p = c.gaps2,
                          f = t.childNodes.slice(),
                          m = e.childNodes.slice(),
                          g = Math.min(u.length, p.length),
                          b = [],
                          v = 0,
                          w = 0;
                        v < g;
              ...
              const j = (
                  ...
                  childNodes: t
                    .map((t, u) => {
                      ...
                      if (
                        ...
                        p.headerClass && (f.class = c(f.class, p.headerClass)),
                        ...
                        s.filters[u] && (f.class = c(f.class, i.filterActive));
                      if (s.widths[u] && !d) {
                ...
                q = (
                  ...
                  if (
                    ((x.attributes.class = c(x.attributes.class, r.table)),
                    d || h || _)
                  ) {
                    const t = j(
                      e,
                  ...
                  return (
                    ...
                    !1 !== b && (x.attributes.tabindex = String(b)),
                    x
                  );
                };
                ...
                editCellModal() {
                  const t = this.data.cell,
                    ...
                    o = [
                      ...
                      `<label class='${this.options.classes.label}'>${a(
                        i
                      )}</label>`,
                      `<input class='${this.options.classes.input}' value='${a(
                        n(t)
                      )}' type='text'>`,
                      "</div>",
                      `<div class='${this.options.classes.row}'>`,
              ...
              (exports.DataTable = class {
                constructor(t, e = {}) {
                  ...
                  (this.options = {
                    ...
                    (this._dd = new Y(this.options.diffDomOptions || {})),
                    (this.initialized = !1),
                    (this._events = {}),
                    (this._currentPage = 0),
                    (this.onFirstPage = !0),
