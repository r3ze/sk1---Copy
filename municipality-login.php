...
// Check if the passcode is not set in session, redirect to admin-passcode.php
if (!isset($_SESSION['passcode'])) {
  header("Location: admin-passcode.php");
  exit();
}
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  // SQL query to check if the email and password match in the admin table
  ...
  if ($result && $result->num_rows > 0) {
    // Email and password are correct, store the email in the session
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" method="post"
                    ...
                    <div class="col-12">
                      ...
                      <div class="invalid-feedback">Please enter your Municipality password!</div>
                    </div>
                    <div class="col-12">
