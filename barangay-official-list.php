...
<head>
  ...
  <title>Barangay Official List</title>
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Barangay Official List</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
                ...
                <tbody>
                  ...
                  if ($result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                      ...
                      // echo "<td><button type='button' onclick=\"editRecord('" . $row["id"] . "')\"
                      // class='btn btn-primary' data-bs-toggle='modal' data-bs-target='#editModal'
                      // >Edit</button> <button onclick=\"archiveRecord('" . $row["id"] . "')\">Archive</button></td>";
                    ...
                    // <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#editModal"> Edit Barangay Official </button>
// <button type="button" onclick="editRecord('0')" class="btn btn-primary">Edit</button>
                      echo "</tr>";
                    }
                  } else {
            ...
            xhttp.open("GET", "edit-barangay-official.php?id=" + id, true);
            xhttp.send();
        }
                function archiveRecord(id) {
                  ...
                  xhttp.open("GET", "archive-barangay-official.php?id=" + id, true);
                  xhttp.send();
                }
              </script> -->
